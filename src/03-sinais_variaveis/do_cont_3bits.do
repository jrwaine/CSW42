...
vcom -reportprogress 300 -work work ./../../cont_3bits.vhd
vcom -reportprogress 300 -work work ./../../cont_3bits_tb.vhd

vsim +altera -l msim_transcript -gui gate_work.cont_3bits_tb
